          ...
          <form method="post" action="{{route('questions.store')}}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data" >
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="Description" id="input-name" type="text" placeholder="{{ __('Question') }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
               ...
               <div class="row">
                  <label class="col-sm-2 col-form-label">{{ __('Score Category') }}</label>
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="Description" id="input-name" type="text" placeholder="{{ __('Question') }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
