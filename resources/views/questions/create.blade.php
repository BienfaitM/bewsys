               ...
               <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="Question_Category" id="input-name" type="text" placeholder="{{ __('Question') }}" required="true" aria-required="true"/>
                      @if ($errors->has('name'))
