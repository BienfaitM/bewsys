@extends('layouts/app', ['activePage' => 'login', 'title' => 'BEWSYS'])

@section('content')
    <div class="full-page section-image" data-color="black" data-image="{{ asset('https://image.freepik.com/free-photo/customer-marketing-sales-dashboard-graphics-concept_53876-133831.jpg') }}">
